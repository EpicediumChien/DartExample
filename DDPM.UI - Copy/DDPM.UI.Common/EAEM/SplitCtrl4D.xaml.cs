...
namespace DDPM.UI.Common.EAEM
{
    ...
    /// </summary>
    public partial class SplitCtrl4D : UserControl, ISplit
    {
        #region Basic

        public Type CtrlType => typeof(SplitCtrl4D);
        ...
        public SplitCtrl4D(List<double>? settings = null)
        {
            InitializeComponent();
            if (settings != null)
        ...
        {
            return new SplitCtrl4A(settings);
        }
        ...
        public List<double> GetSettings()
        {
            ...
            if (g0.ColumnDefinitions.Count >= 7)
            {
                listOut.Add(g0.ColumnDefinitions[0].Width.Value);
                listOut.Add(g0.ColumnDefinitions[2].Width.Value);
                listOut.Add(g0.ColumnDefinitions[4].Width.Value);
                listOut.Add(g0.ColumnDefinitions[6].Width.Value);
            }
            return listOut;
        }
        ...
        public bool SetSettings(List<double> settings)
        {
            ...
            g0.ColumnDefinitions[4].Width = new GridLength(settings[2], GridUnitType.Star);
            g0.ColumnDefinitions[6].Width = new GridLength(settings[3], GridUnitType.Star);
            return true;
        }
