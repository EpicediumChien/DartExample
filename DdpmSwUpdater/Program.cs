...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        try
        {
            ...
            DDPMRegistryHelper.WriteRegistryKey(RegistryHive.LocalMachine, "SOFTWARE\\Dell Display and Peripheral Manager", "MiniInstaller", parentFolderName);
        }
        ...
        LogManage.LogMessage($"MiniInstaller End Resule:{ret.ToString()}");
    }
}