...
namespace DDPM.UI.Module.Collaboration {
  ...
  public partial class CollaborationRightView : UserControl {
    ...
    readonly string LearnMoreCaption = "Learn More";
    readonly string LearnMoreText1 = "To use Collaboration Keyboard with Microsoft Teams, open Teams and go to privacy settings.\n\nSelect Third-party app API and ensure that Dell Display and Peripheral Manager is not on the blocked list.\n\nYou’ll then be able to pair Microsoft Teams with Dell Display and Peripheral Manager again by launching a Microsoft Teams conference call.";
    readonly string LearnMoreText2 = "If you are still having trouble, contact your IT department (if applicable) as they may have policies in place that are prohibiting Collaboration Keyboard from connecting to Microsoft Teams.";
    readonly string Alert1 = "To use Collaboration Keyboard you need the latest version of Zoom or Microsoft Teams";
    readonly string Alert2 = "Connect Collaboration Keyboard with Microsoft Teams by starting a conference call and accepting the connection request";
    readonly string Alert3 = "Collaboration Keyboard cannot connect to Microsoft Teams because you blocked the request. To use Microsoft Teams with Collaboration Keyboard, click \"Learn more\" for instructions on how to re-connect.";
    readonly string Alert4 = "To use Collaboration Keyboard with Zoom, install Zoom’s latest desktop version";
    readonly string Alert5 = "To use Collaboration Keyboard with Microsoft Teams, ensure that you are signed into and using the latest version of Microsoft Teams, and that Third-party app API is enabled";
    readonly string Alert6 = "Connect Collaboration Keyboard with Microsoft Teams by starting a conference call and accepting the connection request";
    readonly string Alert7 = "";
    readonly string Alert8 = "";
    readonly string Alert9 = "";
    readonly string Alert10 = "";
    readonly string Alert11 = "";
    readonly string Alert12 = "";
    readonly string Alert13 = "";
    readonly string LearnMoreLink = "Learn more";
    readonly string VideoCaption = "Video";
    readonly string ShareCaption = "Share";
    readonly string ChatCaption = "Chat";
    readonly string MicCaption = "Mic";
    readonly string OKCaption = "OK";
