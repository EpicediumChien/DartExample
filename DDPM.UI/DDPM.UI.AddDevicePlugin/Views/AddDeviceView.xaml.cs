...
namespace DDPM.UI.Plugin.AddDevicePlugin
{
    ...
    public partial class AddDeviceView : UserControl
    {
        ...
        private readonly string CancelButtonCaption = "Cancel";
        private readonly string WaitingCaption = "Adding device, please wait...";
        private readonly string WaitingMessage = "Pairing";
        private readonly string WaitingAlert = "Pairing may take some time. Do not disconnect your device";
