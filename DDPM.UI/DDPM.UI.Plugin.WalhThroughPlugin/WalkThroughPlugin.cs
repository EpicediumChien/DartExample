...
namespace DDPM.UI.Plugin.WalkThroughPlugin
{
    ...
    private void ConfigureServices()
        ...
        /// <summary>
        /// Get HomeDevices and SelectedHomeDevice from DdpmHomePlugin, and add them to WalkThroughPageViewModel
        /// </summary>
        private void PrepareHomeDevices()
        {
            //Get ISettingsPageViewModel, it will be created after ConfigureServices() executed
            WalkThroughPageViewModel? vmDisplay = PluginIoc.GetService<WalkThroughPageViewModel>();
        ...
        {
            _log.Info($"{nameof(WalkThroughPage)} - shown");
