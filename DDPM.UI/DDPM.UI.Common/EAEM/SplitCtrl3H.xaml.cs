...
namespace DDPM.UI.Common.EAEM
{
    ...
    /// </summary>
    public partial class SplitCtrl3H : UserControl, ISplit
    {
        #region Basic

        public Type CtrlType => typeof(SplitCtrl3H);
        ...
        public SplitCtrl3H(List<double>? settings = null)
        {
            InitializeComponent();
            if (settings != null)
        ...
        {
            return new SplitCtrl3H(settings);
        }
