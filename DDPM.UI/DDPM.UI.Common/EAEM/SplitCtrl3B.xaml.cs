...
namespace DDPM.UI.Common.EAEM
{
    ...
    /// </summary>
    public partial class SplitCtrl3B : UserControl, ISplit
    {
        #region Basic

        public Type CtrlType => typeof(SplitCtrl3B);
        ...
        public SplitCtrl3B(List<double>? settings = null)
        {
            InitializeComponent();
            if (settings != null)
        ...
        {
            return new SplitCtrl3B(settings);
        }
        ...
        private List<double> _defaultSettings = new List<double>() { 1, 1, 1 };
        ...
        public List<double> GetSettings()
        {
            ...
            if (g0.ColumnDefinitions.Count >= 5)
            {
