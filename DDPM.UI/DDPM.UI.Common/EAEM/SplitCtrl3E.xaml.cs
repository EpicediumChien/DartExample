...
namespace DDPM.UI.Common.EAEM
{
    ...
    /// </summary>
    public partial class SplitCtrl3E : UserControl, ISplit
    {
        #region Basic

        public Type CtrlType => typeof(SplitCtrl3E);
        ...
        public SplitCtrl3E(List<double>? settings = null)
        {
            InitializeComponent();
            if (settings != null)
        ...
        {
            return new SplitCtrl3E(settings);
        }
