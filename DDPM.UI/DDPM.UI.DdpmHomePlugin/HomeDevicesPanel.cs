...
namespace DDPM.UI.Plugin.DdpmHomePlugin
{
    ...
    internal class HomeDevicesPanel : Panel
    {
        ...
        public static readonly DependencyProperty HorizontalContentAlignmentProperty =
            DependencyProperty.Register("HorizontalContentAlignment", typeof(HorizontalAlignment), typeof(HomeDevicesPanel), new FrameworkPropertyMetadata(HorizontalAlignment.Left, FrameworkPropertyMetadataOptions.AffectsArrange));
