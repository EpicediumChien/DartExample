    ...
    public partial class KVMPIPPBPFullView : UserControl
    {
        ...
        private void USBKVMFinish(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                //        vm.inputList[vm.pcsList["PC1"].InputType].InputName = vm.pcsList["PC1"].InputName;
                //        vm.inputList[vm.pcsList["PC1"].InputType].USBUpstream = vm.pcsList["PC1"].USBUpstream;
                //        vm.inputList[vm.pcsList["PC2"].InputType].InputName = vm.pcsList["PC2"].InputName;
                //        vm.inputList[vm.pcsList["PC2"].InputType].USBUpstream = vm.pcsList["PC2"].USBUpstream;
                ...
                //                vm.inputList[vm.pcsList["PC3"].InputType].InputName = vm.pcsList["PC3"].InputName;
                //                vm.inputList[vm.pcsList["PC3"].InputType].USBUpstream = vm.pcsList["PC3"].USBUpstream;
                ...
                //                        vm.inputList[vm.pcsList["PC4"].InputType].InputName = vm.pcsList["PC4"].InputName;
                //                        vm.inputList[vm.pcsList["PC4"].InputType].USBUpstream = vm.pcsList["PC4"].USBUpstream;
