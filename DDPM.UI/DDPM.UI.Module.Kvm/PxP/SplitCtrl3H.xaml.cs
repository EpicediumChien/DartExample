...
namespace DDPM.UI.Module.Kvm
{
    ...
    /// </summary>
    public partial class PBPSplitCtrl3H : UserControl
    {
        ...
        public Type CtrlType => typeof(PBPSplitCtrl3H);

        #endregion Basic

        #region Creation

        public PBPSplitCtrl3H()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        public UInt16 PbpCapabilityCode { get; set; } = 0x0033;
        ...
        private void PBP_MouseLeftDown1(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                vm.PC1Click();
                vm.VideoSwapContent = new PBPSplitCtrl3H();
                vm.VideoSwapContent_Left = new PBPSplitCtrl3H();
            }
        }
