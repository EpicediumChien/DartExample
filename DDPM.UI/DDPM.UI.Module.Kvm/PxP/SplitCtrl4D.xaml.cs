...
namespace DDPM.UI.Module.Kvm
{
    ...
    /// </summary>
    public partial class PBPSplitCtrl4D : UserControl
    {
        ...
        public Type CtrlType => typeof(PBPSplitCtrl4D);

        #endregion Basic

        #region Creation

        public PBPSplitCtrl4D()
        {
            InitializeComponent();
        }
        ...
        /// </summary>
        public UInt16 PbpCapabilityCode { get; set; } = 0x0042;
        ...
        private void PBP_MouseLeftDown1(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                vm.PC1Click();
                vm.VideoSwapContent = new PBPSplitCtrl4D();
                vm.VideoSwapContent_Left = new PBPSplitCtrl4D();
            }
        }
        ...
        private void PBP_SwapClick2(object sender, MouseButtonEventArgs e)
        {
            if (vm != null)
            {
                vm.PCSwap("PC2", "PC3");
                if (!vm.isPxPFullView && 
                    DdpmCommonHelper.DeviceManagerSA.VideoSwap(vm.KvmModule.SelectedHomeDevice.MonitorInfo, 1, 2).Result)
                {
                    vm.UpdatePCList();
                }
            }
        ...
        private void PBP_SwapClick3(object sender, MouseButtonEventArgs e)
        {
            if (vm != null)
            {
                vm.PCSwap("PC1", "PC3");
                if (!vm.isPxPFullView && 
                    DdpmCommonHelper.DeviceManagerSA.VideoSwap(vm.KvmModule.SelectedHomeDevice.MonitorInfo, 0, 2).Result)
                {
                    vm.UpdatePCList();
                }
            }
        ...
        private void PBP_SwapClick4(object sender, MouseButtonEventArgs e)
        {
            if (vm != null)
            {
                vm.PCSwap("PC1", "PC4");
                if (!vm.isPxPFullView && 
                    DdpmCommonHelper.DeviceManagerSA.VideoSwap(vm.KvmModule.SelectedHomeDevice.MonitorInfo, 0, 3).Result)
                {
                    vm.UpdatePCList();
                }
            }
        ...
        private void PBP_SwapClick5(object sender, MouseButtonEventArgs e)
        {
            if (vm != null)
            {
                vm.PCSwap("PC2", "PC4");
                if (!vm.isPxPFullView && 
                    DdpmCommonHelper.DeviceManagerSA.VideoSwap(vm.KvmModule.SelectedHomeDevice.MonitorInfo, 1, 3).Result)
                {
                    vm.UpdatePCList();
                }
            }
        ...
        private void PBP_SwapClick6(object sender, MouseButtonEventArgs e)
        {
            if (vm != null)
            {
                vm.PCSwap("PC3", "PC4");
                if (!vm.isPxPFullView && 
                    DdpmCommonHelper.DeviceManagerSA.VideoSwap(vm.KvmModule.SelectedHomeDevice.MonitorInfo, 2, 3).Result)
                {
                    vm.UpdatePCList();
                }
            }
