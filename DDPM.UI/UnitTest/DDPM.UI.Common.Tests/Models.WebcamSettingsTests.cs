...
namespace DDPM.UI.Common.Tests
{
    ...
    public class WebcamSettingsTests
    {
        ...
        public void TestImportWebcamSettings()
        {
            ...
            var result = WebcamSettings.ImportWebcamSettings("model", new DeviceInfo() { ModelNumber= "WB5023",CustomProfiles=new Newtonsoft.Json.Linq.JArray() , PresetProfiles =new Newtonsoft.Json.Linq.JArray()});
            // Assert
