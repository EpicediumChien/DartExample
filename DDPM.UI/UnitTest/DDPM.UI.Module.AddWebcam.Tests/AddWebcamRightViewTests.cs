...
namespace DDPM.UI.Module.AddWebcam.Tests
{
    ...
    public class AddWebcamRightViewTests
    {
        private AddWebcamRightView? addWebcamRightView;
        ...
        [Test]
        public void TestConstructor_AddWebcamRightView()
        {
            // Assert
            Assert.That(addWebcamRightView, Is.Not.Null);
