...
namespace DDPM.UI.Module.Collaboration.Test
{
    ...
    public class CollaborationRightViewTests
    {
        ...
        public void SetUp()
        {
            ...
            vm = new KeyboardViewModel(consoleMock.Object, logMock.Object, deviceManagerMock.Object);
        ...
        public void TestConstructor()
        {
            ...
            var _synthesizer = privateObject.GetFieldOrProperty("_synthesizer");
            ...
            //Assert.That(vmField, Is.EqualTo(vm));
