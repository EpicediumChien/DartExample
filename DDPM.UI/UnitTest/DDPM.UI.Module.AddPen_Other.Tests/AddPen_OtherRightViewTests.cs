...
namespace DDPM.UI.Module.AddPen_Other.Tests
{
    ...
    public class AddPen_OtherRightViewTests
    {
        private AddPen_OtherRightView? addPen_OtherRightView;
        ...
        public void Setup()
        {
            ...
            addPen_OtherRightView = new AddPen_OtherRightView(vm);
            privateObject = new PrivateObject(addPen_OtherRightView);
        }

        [Test]
        public void TestConstructor_AddPen_OtherRightView()
        {
            // Assert
            Assert.That(addPen_OtherRightView, Is.Not.Null);
