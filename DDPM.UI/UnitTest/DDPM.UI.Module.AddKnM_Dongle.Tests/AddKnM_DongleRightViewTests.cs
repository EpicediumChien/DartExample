...
namespace DDPM.UI.Module.AddKnM_Dongle.Tests
{
    ...
    public class AddKnM_DongleRightViewTests
    {
        private AddKnM_DongleRightView? addKnM_DongleRightView;
        ...
        public void Setup()
        {
            ...
            addKnM_DongleRightView = new AddKnM_DongleRightView(vm);
            privateObject = new PrivateObject(addKnM_DongleRightView);
        }
        ...
        {
            // Assert
            Assert.That(addKnM_DongleRightView, Is.Not.Null);
            Assert.That(privateObject.GetFieldOrProperty("_vm"), Is.EqualTo(vm));
            Assert.That(addKnM_DongleRightView.DataContext, Is.EqualTo(privateObject.GetFieldOrProperty("_vm")));
        }
