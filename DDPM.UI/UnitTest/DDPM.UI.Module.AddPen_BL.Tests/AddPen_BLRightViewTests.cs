...
namespace DDPM.UI.Module.AddPen_BL.Tests
{
    ...
    public class AddPen_BLRightViewTests
    {
        private AddPen_BLRightView? addPen_BLRightView;
        ...
        [Test]
        public void TestConstructor_AddPen_BLRightView()
        {
            // Assert
            Assert.That(addPen_BLRightView, Is.Not.Null);
