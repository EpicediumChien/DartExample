...
namespace DDPM.UI.Module.AddHeadset_Wired.Tests
{
    ...
    public class AddHeadset_WiredRightViewTests
    {
        private AddHeadset_WiredRightView? addHeadset_WiredRightView;
        ...
        [Test]
        public void TestConstructor_AddHeadset_WiredRightView()
        {
            // Assert
            Assert.That(addHeadset_WiredRightView, Is.Not.Null);
