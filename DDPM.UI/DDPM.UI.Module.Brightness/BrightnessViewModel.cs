        ...
        public void SynchronizeBtnExpectedResult(string str)
        {
            switch (str)
            {
                ...
                case "C":
                    ...
                    DdpmCommonHelper.WriteUILog($"[DisplayHotkey] Synchronize between monitors is displayed and not greyed out with default is OFF");
                    break;

                case "D":
                    IsSynchronizeDisabled = true;
                    isShowSynchronize = Visibility.Visible;
                    DdpmCommonHelper.WriteUILog($"[DisplayHotkey] Synchronize between monitors is displayed but greyed out");
                    break;

                case "E":
                    isShowSynchronize = Visibility.Collapsed;
                    DdpmCommonHelper.WriteUILog($"[DisplayHotkey] Synchronize between monitors is NOT displayed");
                    break;
