...
namespace DDPM.UI.Plugin.ViewModels {
  public class PeripheralViewModel : ObservableObject, IPeripheralViewModel {
    ...
    public virtual void HandleNotification(DeviceChangedType changeType, DeviceInfo di, string property = "") {
      switch(changeType) {
        case DeviceChangedType.Peripherals_PlugIn:
          if(DeviceInfos.ContainsKey(di.ID)) { DeviceInfos.Remove(di.ID); }
    ...
    public new virtual void OnPropertyChanged([CallerMemberName] string propertyName = "") {
    }
    ...
    public string USBWirelessReceiverVersion { get { return PhysicalDeviceFWVersion; } }
    ...
    /// </summary>
    readonly List<VbarItem> _vbarItems = new();
