...
{
    public class PenSettingsModule : IDdpmModule
    {
        private UserControl? _leftView = null;
        private UserControl _rightView;

        public PenSettingsModule(PenViewModel vm)
        {
            _rightView = new PenSettingsRightView(vm);
        }

        public string ModuleName { get => "PenSettingsModule"; }
