...
namespace VcpCore.Common
{
    public static class VcpCodeList
    {
        ...
        public static readonly Dictionary<string, uint> VCP60 = new Dictionary<string, uint>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"DVI1" , 0x03 },
            {"DVI2" , 0x04 },
            {"Composite video1" , 0x05 },
            {"Composite video2" , 0x06 },
            {"S-Video1" , 0x07 },
            {"S-Video2" , 0x08 },
            {"Tuner1" , 0x09 },
            {"Tuner2" , 0x0A },
            ...
            {"DisplayPort1" , 0x0F },
            {"Mini DisplayPort1" , 0x10 },
            {"HDMI1" , 0x11 },
            {"HDMI2" , 0x12 },
            {"DisplayPort2" , 0x13 },
            {"Mini DisplayPort2" , 0x14 },
            {"HDMI3" , 0x15 },
            {"HDMI4" , 0x16 },
            {"DisplayPort3" , 0x17 },
            {"Mini DisplayPort3" , 0x18 },
            {"Thunderbolt1" , 0x19 },
            {"Thunderbolt2" , 0x1A },
            {"USB-C1" , 0x1B },
            {"USB-C2" , 0x1C },
        ...
        public static readonly Dictionary<string, byte> VCPF0 = new Dictionary<string, byte>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Bright", 61 }, // Jim add 2025 for [S3225QC] HDR list
            { "Dark", 62 }, // Jim add 2025 for [S3225QC] HDR list
            { "Game", 63 } // Jim add 2025 for [S3225QC] HDR list
        };
        ...
        public static readonly Dictionary<int, string> VCPE2 = new Dictionary<int, string>
        {
            ...
            { 64, "Bright" }, // Jim add 2025 for [S3225QC] HDR list
            { 62, "Dark" }, // Jim add 2025 for [S3225QC] HDR list
            { 63, "Game" } // Jim add 2025 for [S3225QC] HDR list
        ...
        public static readonly Dictionary<string, int> VCPE2_ref = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Bright", 64 }, // Jim add 2025 for [S3225QC] HDR list
            { "Dark", 62 }, // Jim add 2025 for [S3225QC] HDR list
            { "Game", 63 } // Jim add 2025 for [S3225QC] HDR list
        };
