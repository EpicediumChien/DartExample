...
namespace DDPM.Easy.Common
{
    ...
    /// </summary>
    public partial class SplitCtrl2B : UserControl, ISplitCtrl, IDisposable
    {
        ...
        public string TooltipResourceName { get; } = "EATooltip_22";
        ...
        public void InitCellList()
        {
            ...
            cellListV.Clear();
            cellListV.Add(new CellObj("2B1", cell_2B1) { rcRatio = new Rect(0.5, 0, 0.5, 1) });
            cellListV.Add(new CellObj("2B2", cell_2B2) { rcRatio = new Rect(0, 0, 0.5, 1) });
        }
        ...
        public void UpdateRatioRectsFromSettings()
        {
            ...
            if (VM.IsVertical)
            {
                ...
                if (cx > 0)
                {
                    ...
                    //2B2
                    cellListV[1].rcRatio = new Rect(0, 0, VM.Settings_Double[1] / cx, 1);
                    //2B1
        ...
        private string _defaultHorzName = //LangHelper.Instance[$"EATooltip_22H"];
        "Option 2.2: 2 rows, split equally.";
        private string _defaultVertName = //LangHelper.Instance[$"EATooltip_22V"];
        "Option 2.2: 2 columns, split equally.";
