...
{
    /// <summary>
    /// Interaction logic for SplitCtrl7A.xaml
    /// </summary>
    public partial class SplitCtrl7A : UserControl, ISplitCtrl, IDisposable
    {
        ...
        public string CtrlClass => nameof(SplitCtrl7A);
        ...
        public int EAID { get; set; } = 39;
        public string TooltipResourceName { get; } = "EATooltip_71";
        ...
        {
            SplitCtrl7A ctrl = new SplitCtrl7A();
        ...
        {
            cellListH.Clear();
            cellListH.Add(new CellObj("7a1", cell_7a1) { rcRatio = new Rect(0, 0, 1 / 3, 1 / 2) });
            cellListH.Add(new CellObj("7a2", cell_7a2) { rcRatio = new Rect(1 / 3, 0, 1 / 3, 1 / 2) });
            cellListH.Add(new CellObj("7a3", cell_7a3) { rcRatio = new Rect(2 / 3, 0, 1 / 3, 1 / 2) });
            cellListH.Add(new CellObj("7a4", cell_7a4) { rcRatio = new Rect(0, 1 / 2, 1 / 3, 1 / 2) });
            cellListH.Add(new CellObj("7a5", cell_7a5) { rcRatio = new Rect(1 / 3, 1 / 2, 1 / 3, 1 / 2) });
            cellListH.Add(new CellObj("7a6", cell_7a6) { rcRatio = new Rect(2 / 3, 1 / 2, 1 / 3, 1 / 2) });
            cellListH.Add(new CellObj("7a7", cell_7a7) { rcRatio = new Rect(2 / 3, 1 / 2, 1 / 3, 1 / 2) });

            cellListV.Clear();
            cellListV.Add(new CellObj("7A1", cell_7A1) { rcRatio = new Rect(0, 2 / 3, 1 / 2, 1 / 3) });
            cellListV.Add(new CellObj("7A2", cell_7A2) { rcRatio = new Rect(0, 1 / 3, 1 / 2, 1 / 3) });
            cellListV.Add(new CellObj("7A3", cell_7A3) { rcRatio = new Rect(0, 0, 1 / 2, 1 / 3) });
            cellListV.Add(new CellObj("7A4", cell_7A4) { rcRatio = new Rect(1 / 2, 2 / 3, 1 / 2, 1 / 3) });
            cellListV.Add(new CellObj("7A5", cell_7A5) { rcRatio = new Rect(1 / 2, 1 / 3, 1 / 2, 1 / 3) });
            cellListV.Add(new CellObj("7A6", cell_7A6) { rcRatio = new Rect(1 / 2, 0, 1 / 2, 1 / 3) });
            cellListV.Add(new CellObj("7A7", cell_7A7) { rcRatio = new Rect(1 / 2, 0, 1 / 2, 1 / 3) });
        }
        ...
        public List<double> DefaultSettings => new List<double>() { 1, 1, 1, 3, 7, 1, 1 };
        #endregion Settings

        #region FriendlyName
        private string _friendlyName = string.Empty;
        private string _defaultHorzName = //LangHelper.Instance[$"EATooltip_71H"];
        "Option 7.1: 2 rows, split 30/70%. Row 1, split equally in 3 sections. Row 2, split 30/70%. Column 1, split equally. Columns 2 and 3, no splits.";
        private string _defaultVertName = //LangHelper.Instance[$"EATooltip_71V"];
        "Option 7.1: 3 rows, split equally. Rows 1 and 2, each split 30/70%, Row 3, split in 3 equal sections.";
