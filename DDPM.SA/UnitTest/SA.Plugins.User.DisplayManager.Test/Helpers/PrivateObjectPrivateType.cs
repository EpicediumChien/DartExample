...
namespace Dell.Client.Framework.UnitTestShared.Tests
{
    /// <summary>
    ...
    {
        // bind everything
        private const BindingFlags BindToEveryThing = BindingFlags.Default | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public | BindingFlags.Static;
