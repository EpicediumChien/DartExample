                                ...
                                if (_monitorIndeies != null)
                                {
                                    ...
                                    if (monitor != null)
                                    {
                                        ...
                                        foreach (var property in jsonObject.Properties())
                                        {
                                            ...
                                            var monitor_incase = MonitorInfo_Reget.SingleOrDefault(x => x.edid.ServiceTag.ToString().Equals(commandLineInput.ServiceTag[0].ToString(), StringComparison.OrdinalIgnoreCase));
