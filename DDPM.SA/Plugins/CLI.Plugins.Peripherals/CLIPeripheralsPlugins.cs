        ...
        public CLIEventResult SetCommandArgs(CLIEventArgs input, IDeviceManagerSA devMgr)
        {
            ...
            if (commandLineInput != null)
            {
                ...
                if (commandLineInput.Command.Equals("SET") &&
                    ...
                    commandLineInput.TargetFeature.Equals("SILENTFWUPDATE"))// for dock firmware update.
                {                    
                    //switch (commandLineInput.TargetFeature)
                    //{
                    //    case "FIRMWAREUPDATE":
                ...
                if (commandLineInput.Command.Equals("SET"))
                {
                    if (commandLineInput.TargetType.Equals("APP") &&
                        commandLineInput.TargetFeature.Equals("UPDATE"))// for dock firmware update.
                    {                        
                        //switch (commandLineInput.TargetFeature)
                        //{
                        //    case "FIRMWAREUPDATE":
                ...
                if (commandLineInput.Command.Equals("GET") && commandLineInput.TargetType.Equals("APP") &&
                    commandLineInput.TargetFeature.Equals("UPDATESOURCELOCATION"))// for dock firmware update.
                {
                    //switch (commandLineInput.TargetFeature)
                    //{
                    //    case "FIRMWAREUPDATE":
