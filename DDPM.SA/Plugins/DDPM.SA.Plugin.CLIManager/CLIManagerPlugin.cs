...
namespace DDPM.SA.Plugin.CLIManager
{
    ...
    public class CLIManagerPlugin : BaseAgentPlugin, IDisposableObservable, ICliManagerSA, ICliManagerIT
    {
        ...
        public bool checkDefer(int from, string guid, string commanddata)
        {
            ...
            return checkToastResult(did, item);
        }

        public bool checkDeferSchedule(int from, string guid, DeferItem item)
        {
            string did = item.deferid;
        ...
        public void showNotification(int from, string guid, DeferItem item)
        {
            string did = item.deferid;
