...
namespace DDPM.SA.Plugins.User.DisplayProperties
{
    public class user32
    {
        ...
        [DllImport("dxva2.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool GetVCPFeatureAndVCPFeatureReply(IntPtr hMonitor, byte bVCPCode, ref MC_VCP_CODE_TYPE pvct, ref int pdwCurrentValue, ref int pdwMaximumValue);
        ...
        [DllImport("dxva2.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool CapabilitiesRequestAndCapabilitiesReply(IntPtr hMonitor, byte[] pszASCIICapabilitiesString, uint dwCapabilitiesStringLengthInCharacters);
