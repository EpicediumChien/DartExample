    ...
    public class NodeFormatter : INodeFormatter
    {
        ...
        public static string FormatVCP_60(string vcpControlName)
        {
            switch (vcpControlName)
            {
                ...
                case "10": return "Mini DisplayPort-1";
                case "11": return "HDMI-1";
                case "12": return "HDMI-2";
                case "13": return "DisplayPort-2";
                case "14": return "Mini DisplayPort-2";
                case "15": return "HDMI3";
                case "16": return "HDMI4";
                case "17": return "DisplayPort-3";
                case "18": return "Mini DisplayPort-3";
                case "19": return "Thunderbolt-1";
                case "1a": return "Thunderbolt-2";
